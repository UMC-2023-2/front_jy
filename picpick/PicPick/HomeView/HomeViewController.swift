...
class HomeViewController: UIViewController {
    ...
    private func updateMainViewForMemoriesAlbum() {
        ...
        print("추억앨범")
        isshareStatus = false
        //HomeViewModelManager().getUserNonShareAlbumList(self)
    ...
    private func updateMainViewForTogetherAlbum() {
        ...
        print("함께앨범")
        isshareStatus = true
        //HomeViewModelManager().getUserShareAlbumList(self)
    }
...
extension HomeViewController: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if isshareStatus {
            ...
            cell.albumTitleView.text = albumList[indexPath.row - 1].name
            cell.productImageView.load(url: URL(string: albumList[indexPath.row - 1].titleImgUrl)!)
            cell.photoNum.text = String(albumList[indexPath.row - 1].sharedAlbumsIds.count)
        }
...
extension HomeViewController {
    func successAPI(_ result: [AlbumModel]) {
        albumList = result
        print(albumList)
    }
}
